        ...
        <Card className="w-80 bg-black/20 backdrop-blur-md border-white/10">
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <Select value={selectedBody1} onValueChange={(value) => setSelectedBody1(value as CelestialBodyKey)}>
            ...
            <div className="space-y-2">
              ...
              <Select value={selectedBody2} onValueChange={(value) => setSelectedBody2(value as CelestialBodyKey)}>
                <SelectTrigger className="bg-gray-800 border-gray-600 text-white">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent className="bg-gray-800 border-gray-600">
